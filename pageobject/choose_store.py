...
class Store:
    ...
    def choose_address(self):
        ...
        browser.element('button._15pyi span.hfHvU').click()
        return self
    ...
    def assert_successful_choose_address(self):
        ...
        assert browser.element('div.Uvxie.vDuDP').should(have.text('Мира'))
        assert browser.element('div.Uvxie.vDuDP').should(have.text('1'))
